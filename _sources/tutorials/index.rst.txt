...
and viscosity. The pieces are brought together in tutorials 5 and 6, which focus on confined fluids and lubrication problems.
Tutorial 7 introduces Gaussian Processes for surrogate modeling of the micro-problem with Molecular Dynamics, 
and the final tutorial introduces elastic deformation of the solid surfaces.
